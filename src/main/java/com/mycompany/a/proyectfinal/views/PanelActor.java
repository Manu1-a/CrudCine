...
public class PanelActor extends JPanel {
    ...
    public PanelActor(ActionListener actionListener) {
    ...
    public void loadData(ArrayList<Actor> list) {
        for (Actor actor : list) {
            this.model.addRow(new Object[]{actor.getIdActor(), actor.getNameActor()});
        }
    }
